...
public class CommentController {
    ...
    public ResponseEntity<Object> createComment(@Valid @RequestBody CommentDTO commentDTO,
        ...
        Comment comment = commentsService.saveComment(Long.parseLong(postId), commentDTO, principal);
    ...
    public ResponseEntity<List<CommentDTO>> getAllCommentsToPost(@PathVariable("postId") String postId) {
        List<CommentDTO> commentDTOList = commentsService.getAllCommentsForPost(Long.parseLong(postId))
                .stream()
    ...
    public ResponseEntity<MessageResponse> deleteComment(@PathVariable("commentId") String commentId) {
        commentsService.deleteComment(Long.parseLong(commentId));
